...
async function tick(serverID, userID, data) {
    ...
    if (getUserVar(serverID, userID, "confectionaryDissolveTimer") < Date.now() && getGag(serverID, userID, "chocolate") && (process.recentmessages[serverID] && process.recentmessages[serverID][userID])) {
