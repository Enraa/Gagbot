...
exports.canAddLock = (data) => {
    return getCurrentHoliday("LocktoberPrep");
}
...
exports.desc = `A mysterious lock in the shape of a carved pumpkin. This lock automatically falls off, but becomes completely unremovable during the month of October. Can be applied a week early and removed during that week. \n\n**Note: Nobody will have access to this restraint until November!**`
exports.itemdescription = undefined;
...
exports.lockStatus = function (data) {
    ...
    let lockemoji = "🔑"
    return `${lockemoji} Waiting for Locktober!`
}
